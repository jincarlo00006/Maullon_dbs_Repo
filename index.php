    ...
    if (isset($_POST['add_course'])){
      ...
      if($userID){
        ...
        Swal.fire({
          icon: 'success',
          title: 'Registration Successful',
          text: 'You have successfully registered a new course.',
          confirmButtonText: 'OK'
      }).then(()=>{
      window.location.href = 'login.php'
      });
...
<body class="bg-light">
  ...
  <div class="modal fade" id="addCourseModal" tabindex="-1">
    <div class="modal-dialog">
      <form class="modal-content" method="POST" action="">
        ...
        <div class="modal-footer">
          <button type="submit" name="add_course" id="addcourse" class="btn btn-success">Add Course</button>
        </div>
  ...
  courseField.addEventListener('input', () => {
    ...
    if (course_name === '') {
      ...
      courseField.nextElementSibling.textContent = 'Username is required.';
      add_course.disabled = true;
      return;
    }
